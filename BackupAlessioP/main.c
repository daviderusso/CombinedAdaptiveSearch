...
int main() {
    ...
    const char *filein = "data/160WInstancesHeur_new.csv";
    const char *outfile = "data/results_heur_W.csv";
    const char *filetime = "data/results_times_heur_W.csv";
    ...
    while (fgets(buffer, sizeof(buffer), fp)) {
        ...
        BinaryCombinedHeuristic_AStar(graph, reverseGraph, source, target, W, Risultati);
