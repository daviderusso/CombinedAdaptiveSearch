...
void BinaryCombinedHeuristic_AStar(Graph * graph, Graph* reverse_graph, int source, int destination, double W, Results * Risultati){
    ...
    Risultati->SP_Length = SP_length;
    Risultati->SP_SunLength = SP_sunLength;
    Risultati->SPL_Length = SP_Cost1_Length;
